...
const registTrans = "insert into translators values ($1,$2,$3,$4,$5,$6,$7,$8)";
const updateTrans = "update translators set  where tra_id = $1";
const deleteTrns = "delete from translators where tra_id = $1";
