...
const addCharacter =
  "insert into series_characters (character_name, voice_actor_id) values ($1,$2)";
const updateCharacter =
  "update series_character set character_name = $2, voice_actor_id = $3 where";
const deleteCharacter =
  "delete from series_characters where series_id = $1 and character_name = $2";

// voice actor
const selectVoiceActors = "select * from voice_actor";
const addVoiceActor =
  "insert into voice_actor (first_name, last_name, birth_date) values ($1,$2,$3)";
const updateVoiceActor =
  "update voice_actor set first_name = $2, last_name = $3, birth_date = $4 where voice_actor_id = $1";
...
const updateCustomer =
  "update customers set first_name = $2, last_name = $3, birth_date = $4, gender = $5,username = $6, password = $7 where cus_id = $1";
...
const updateCudNum =
  "update cus_numbers set cus_number = $3 where cus_id = $1 and cus_number = $2";
const deleteCusNum =
  "delete from cus_numbers where cus_id = $1 and cus_number = $2";

//customer mails
const selectCusMail = "select * from cus_mail";
const addCusMail = "insert into cus_mail (cus_id, cus_mail) values ($1,$2)";
const updateCusMail =
  "update cus_mail set cus_mail = $3 where cus_id = $1 and cus_mail = $2";
const deleteCusMail =
  "delete from cus_mail where cus_id = $1 and cus_mail = $2";

//translator
const selectTrans = "select * from translators";
const loginTrans =
  "select * from translators where username = $1 and password = $2";
const registTrans =
  "insert into translators (first_name,last_name,regist,birth_date,ranke_id,email,username,password) values ($1,$2,$3,$4,$5,$6,$7,$8)";
const updateTrans =
  "update translators set first_name = $2, last_name = $3, regist = $4, birth_date = $5, ranke_id = $6, email = $7, username = $8, password = $9 where tra_id = $1";
const deleteTrans = "delete from translators where tra_id = $1";

//translator number
const selectTraNumbers = "select * from tra_numbers";
const addTraNumber =
  "insert into tra_numbers (tra_id, tra_number) values ($1, $2)";
const updateTraNumber =
  "update tra_numbers set tra_number = $2 where tra_id = $1"; //TO DO
