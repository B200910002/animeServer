const Query = {
  ...
  addStudio: "insert into studio (studio_name, c_date, found_producer, f_location) values ($1,$2,$3,$4)",
  addTv_series: "insert into tv_series (series_name, publish_date, series_mode, total_episode, description, auth_id, age_order,photo, studio_id) values ($1,$2,$3,$4,$5,$6,$7,$8,$9)",
  updateAuthor: "update authors set first_name = $2,last_name = $3, birth_date = $4, brith_country = $5 where auth_id = $1",
  updateStudio: "update studio set studio_name = $2, c_date = $3, found_producer = $4, f_location = $5 where studio_id = $1",
  updateTv_Series: "update tv_series set series_name = $2, publish_date = $3, series_mode = $4, total_episode = $5, description = $6, auth_id = $7, age_order = $8,photo = $9, studio_id = $10 where series_id = $1",
